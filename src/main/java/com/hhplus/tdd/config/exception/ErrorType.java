...
public enum ErrorType {
    ...
    BALANCE_LIMIT_AMOUNT(ErrorCode.CLIENT_ERROR, "충전 금액이 초과되었습니다.", LogLevel.WARN),
    BALANCE_LESS_THAN_ZERO(ErrorCode.CLIENT_ERROR, "충전 금액은 0보다 커야 합니다.", LogLevel.WARN),
    BALANCE_EXCEEDS_AVAILABLE(ErrorCode.CLIENT_ERROR, "사용하려는 금액이 잔액을 초과할 수 없습니다.", LogLevel.WARN),
